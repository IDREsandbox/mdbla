...
mdbla.mapAction = function(data)
{
	...
	var html = '<div><span class="stats-title">' + mdbla.highlightedGeographyName + '</span><br>Showing booking data from 2012 to 2016<br>Cost ranking: <b>' + (mdbla.costranks.length - mdbla.costranks[mdbla.slugarray.indexOf(mdbla.highlightedData[mdbla.geographyIDColumn[mdbla.geography]])] + 1) + '</b> out of ' + mdbla.costranks.length + ' ' + mdbla.geography + '<table class="table table-sm"><tr><td>2010 population</td><td><strong>' + mdbla.numberWithCommas(mdbla.highlightedData.pop2010) + '</strong></td></tr><tr><td>2010 18 and over population</td><td><strong>' + mdbla.numberWithCommas(mdbla.highlightedData.pop2010_18over) + '</strong></td></tr><tr><td>Rate of incarceration</td><td><strong>' + rateofincarecration +'</strong></td></tr></table></div>';
